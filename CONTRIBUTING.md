...
```bash
# Clone repository
git clone https://github.com/eliashaeussler/scope-profiler.git
cd scope-profiler
...
Once the changes are ready, please [submit a pull request](https://github.com/eliashaeussler/scope-profiler/compare)
